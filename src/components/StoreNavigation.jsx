    ...
    <div>
      ...
      <Dialog open={open} onClose={setOpen} className="relative z-40 lg:hidden">
        ...
        <div className="fixed inset-0 z-40 flex">
          <DialogPanel
            transition
            className="relative flex w-full max-w-xs transform flex-col overflow-y-auto bg-gray-0 pb-12 shadow-xl transition duration-300 ease-in-out data-closed:-translate-x-full"
          >
              ...
              <div className="border-b border-gray-200">
                <TabList className="-mb-px flex space-x-8 px-4">
                  {navigation.categories.map((category) => (
                    <Tab
                      key={category.name}
                      className="flex-1 border-b-2 border-transparent px-1 py-4 text-base font-medium whitespace-nowrap text-gray-900 data-selected:border-indigo-600 data-selected:text-indigo-600  data-focus:outline-none focus:outline-none"
                    >
                      {category.name}
                    </Tab>
                  ))}
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              <button
                ...
                className="relative rounded-md bg-gray-0 p-2 text-gray-400 lg:hidden"
              >
                <span className="absolute -inset-0.5" />
                ...
                <div className="flex h-full space-x-8">
                  {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      ...
                      >
                        ...
                        <div
                          aria-hidden="true"
                          className="absolute inset-0 top-1/2 bg-gray-0 shadow-sm"
                        />
                  ...
                  {navigation.pages.map((page) => (
                    <a
                      key={page.name}
                      href={page.href}
                      className="outline-0 flex items-center text-sm font-medium text-gray-700 hover:text-gray-800"
                    >
                      {page.name}
                    </a>
                  ))}
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="lg:ml-8 flex text-indigo-600">
                  <button
                    className="p-2 cursor-pointer"
                    onClick={toggleDarkMode}
                  >
                    {isDarkMode ? (
                      <MoonIcon className="moon size-5" />
                    ) : (
                      <SunIcon className="sun size-5" />
                    )}
                  </button>
                </div>
